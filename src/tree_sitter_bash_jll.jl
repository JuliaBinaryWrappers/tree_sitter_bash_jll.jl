...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_bash_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7332bcdc-bd2a-5999-b4fe-680b85f40771"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_bash", artifacts_toml) for e in artifacts["tree_sitter_bash"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_bash; unsupported platform $(triplet(platform_key_abi()))")
else
